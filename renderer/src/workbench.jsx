...
function Workbench() {
  ...
  const sampleData = {
    ...
    y: Array.from(
      { length: 100 },
      (_, i) => Math.sin((i / 100) * 2 * Math.PI * freq)
    ),
  };
  ...
  return (
    <div className="workbench-container">
      ...
      <p>Use this area to test components, colors, and interactions without the full app.</p>
      ...
      <div className="widget-demo">
        ...
        <button className="dark-button secondary">Secondary Button</button>
      </div>
